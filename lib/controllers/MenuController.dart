...
class MenuControllers extends ChangeNotifier {
  ...
  final GlobalKey<ScaffoldState> _ordersScaffoldKey =
      GlobalKey<ScaffoldState>();
        // users screen
  final GlobalKey<ScaffoldState> _usersScaffoldKey =
      GlobalKey<ScaffoldState>();
 ...
 // get users screen Scaffold Key
 GlobalKey<ScaffoldState> get getusersScaffoldKey => _usersScaffoldKey;
  // Callbacks
  ...
  void controlAllOrder() {
   ...
   void controlAllusers() {
    if (!_usersScaffoldKey.currentState!.isDrawerOpen) {
      _usersScaffoldKey.currentState!.openDrawer();
    }
   }
}
