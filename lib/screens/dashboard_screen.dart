...
import 'package:admin_cp/responsive.dart';
import 'package:admin_cp/widgets/grid_products.dart';
import 'package:admin_cp/widgets/orders_list.dart';
...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final menuProvider = MenuController();
    return SafeArea(
